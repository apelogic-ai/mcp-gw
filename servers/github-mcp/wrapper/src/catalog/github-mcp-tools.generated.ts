// Generated from ghcr.io/github/github-mcp-server@sha256:2b0c48b070f61e9d3969269ead600f62d00fb237b60ac849ef3d166ee7de9ad3 (v1.6.0).
// Do not edit by hand; catalog conformance verifies this snapshot against the pinned image.

export const GITHUB_MCP_STABLE_TOOLS = [
  {
    annotations: {
        ...
        workflow_runs_filter: {
          ...
          properties: {
            ...
            branch: {
              type: "string",
              description:
                "Filter workflow runs to a specific Git branch. Use the name of the branch.",
            },
            event: {
              type: "string",
    ...
    inputSchema: {
      ...
      properties: {
        ...
        commentNodeID: {
          type: "string",
          description:
            "The Node ID of the discussion comment (required for 'reply', 'update', 'delete', 'mark_answer', and 'unmark_answer' methods). For 'reply', this is the top-level comment to reply to; GitHub Discussions only support one level of nesting.",
        },
        discussionNumber: {
          type: "number",
  ...
  },
  {
    ...
    inputSchema: {
      ...
      required: ["owner", "repo", "findingNumber"],
    },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        includeReplies: {
          type: "boolean",
          description:
            "When true, each top-level comment will include its replies nested within it (up to 100 replies per comment, which is the GitHub API maximum). Defaults to false.",
        },
        owner: {
          type: "string",
          description: "Repository owner",
      ...
      properties: {
        ...
        iterations: {
          ...
          items: {
            ...
            required: ["title", "start_date", "duration"],
            additionalProperties: false,
          },
          description:
